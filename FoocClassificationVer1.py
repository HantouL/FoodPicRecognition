...
train_transform = transforms.Compose(
    [
        ...
        transforms.RandomResizedCrop(224),  # 放大+裁切到224
        transforms.RandomRotation(50),  # 旋转0~50度
        transforms.ToTensor()
    ]
)
...
class myModel(nn.Module):
    def __init__(self, num_class):
        ...
        self.bn1 = nn.BatchNorm2d(64)  # 卷积
        self.relu = nn.ReLU()  # 归一化
...
# train_path = r"E:\DLDataset\Food\food-11\training\labeled"
# val_path = r"E:\DLDataset\Food\food-11\validation"
...
no_label_loader = DataLoader(no_label_set, batch_size=16, shuffle=False)  # 无标签一定不要打乱
...
optimizer = torch.optim.AdamW(model.parameters(), lr=lr, weight_decay=1e-4)  # AdamW 权重衰减-》平滑曲线
# Adam 与 SGD区别？
